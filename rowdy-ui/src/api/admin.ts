...
import type {
  ...
  DeleteRoundRequest,
  DeleteRoundResult,
  DeleteSideEventRequest,
  DeleteSideEventResult,
  DeleteSideEventTeamRequest,
  EditMatchRequest,
...
export const adminApi = {
  ...
  // Side event (optional, non-scoring 9-hole game)
  createSideEvent: call<CreateSideEventRequest, CreateSideEventResult>("createSideEvent"),
  updateSideEvent: call<UpdateSideEventRequest, AdminResult>("updateSideEvent"),
